...
export const about = {
  ...
  paragraphs: [
    ...
    'At Intervolve, every part of you is met with care — physiological, emotional, and energetic. In a space rooted in safety and intention, healing unfolds at your own pace, allowing true evolution to emerge.',
  ],
  /**
